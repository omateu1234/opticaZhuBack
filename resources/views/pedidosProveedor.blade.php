            ...
            <div class="modal-header border-0">
                <div class="w-100 row mx-1 border-bottom pt-2 pb-3">
                    <div class="col-auto d-flex align-items-center">
                        <h5 class="modal-title tituloModalOutline" id="exampleModalLabel">Recibe el pedido</h5>
                    </div>
                ...
                <form class="form-cli row" method="post" action="{{route('recibirPedido', $pedido->id)}}">
                    ...
                    <div class="col px-2">
                        <div class="row my-2 d-flex justify-content-center">
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-primary  botonRecibirOutline justify-content-end " data-bs-dismiss="modal"> Cancelar</button>
                            </div>
                        </div>
                    </div>
